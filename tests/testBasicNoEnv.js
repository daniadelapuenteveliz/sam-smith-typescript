...
/**
 * Test: testBasicNoEnv
 * Validates that a basic project with no environment variables generates correctly
 */
export async function testBasicNoEnv() {
    const testName = 'testBasicNoEnv';
    ...
    try {
        ...
        await generateProjectProgrammatically({
            ...
            functionName: 'testBasicNoEnv',
            apiName: 'testBasicNoEnv-api',
            timeout: 60,
            envVars: [],
            templateName: 'basic',
            architecture: 'arm64'
        ...
        // try {
        //     await cleanup(generatedProjectPath);
