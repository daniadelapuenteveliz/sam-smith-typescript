...
import {
    ...
    deleteApiGatewayEndpointProgrammatically
...
/**
 * Test: testCreateAndDeleteEndpoints
 * Validates creating and deleting API Gateway endpoints
 */
export async function testCreateAndDeleteEndpoints() {
    const testName = 'testCreateAndDeleteEndpoints';
    ...
    try {
        ...
        // Step 2: Add new endpoint GET /test
        console.log(chalk.gray('  Adding endpoint GET /test...'));
        ...
        results.push({ step: 'GET /test endpoint added', passed: true });

        // Step 3: Delete the endpoint GET /test
        console.log(chalk.gray('  Deleting GET /test endpoint...'));
        await deleteApiGatewayEndpointProgrammatically(outputPath, {
            gatewayName: `${testName}-api`,
            method: 'get',
            path: '/test',
            lambdaName: testName
        ...
        results.push({ step: 'GET /test endpoint deleted', passed: true });
