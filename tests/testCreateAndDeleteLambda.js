...
/**
 * Test: testCreateAndDeleteLambda
 * Validates creating a lambda and then deleting it
 */
export async function testCreateAndDeleteLambda() {
    const testName = 'testCreateAndDeleteLambda';
    ...
    try {
        ...
        // Step 2: Add lambda2 with A1, A2, and A3
        console.log(chalk.gray('  Adding lambda2 with A1, A2, A3...'));
        ...
        results.push({ step: 'lambda2 created with A1, A2, A3', passed: true });

        // Step 3: Delete lambda2
        console.log(chalk.gray('  Deleting lambda2...'));
        await deleteLambdaProgrammatically(outputPath, 'lambda2');

        results.push({ step: 'lambda2 deleted successfully', passed: true });
